...
`extraction_complete.alts_generic` is the count in the document that shipped, beside
`alts_checked` as its denominator. It is deliberately **not** a length rule: the shortest alts
