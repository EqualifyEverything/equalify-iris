...
divides a PDF's page range between as many of them as the host reports: a 25-page
document that took 12.5 s in one process takes 3.9 s across four. It is the uploader who
waits for this — the route rasterizes before it answers — so cores are worth giving a
deployment that takes PDFs.
