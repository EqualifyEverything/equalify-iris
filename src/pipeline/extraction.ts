...
Keep the printing as it stands, hyphen included, where the page breaks a word at its edge. The one
thing to add is the fact itself, in the "log" field — that this page opens mid-sentence, or ends
